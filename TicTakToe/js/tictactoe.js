...
function placeXOrO(squareNumber) {
    ...
    if (!selectSquares.some(element => element.includes(squareNumber))) {
        ...
        //Returning true is needed for our computer's turn to work.
        return true;
    }
}
...
function computerTurn() {
    ...
    while (!success) {
        ...
        //If the random number is evaluated and returns true, the square hasn't been selected yet.
...
function checkWinConditions() {
    ...
    //This conditions checks for a tie. If none of the above conditions are met and
...
//This function makes our body elemnt temporarily unclickable.
...
//This functiom utilizes HTML canvas to draw win lines.
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    //This line accesse our HTML canvas element.
    const canvas = document.getElementById('win-lines');
    //This line givees us access to method and properties to use on canvas.
...
function animateLineDrawing() {
    //This variable variable creates a loop.
    const animationLoop = requestAnimationFrame(animateLineDrawing);
    //This method clears content from the last loop iteration.
    c.clearRect(0, 0, 608, 608);
    //This method starts a new path.
    c.beginPath();
    //This method moves is to a starting point in our line.
    c.moveTo(x1,y1);
    ...
    if (x1 <= x2 && y1 <= y2) {
        //This condition adds 10 to the previous end x endpoints.
        if (x < x2) {x += 10; }
...
//This line disallows clocking while the wind sound is playing.
disableClick();
//this line plays the win sounds.
audio('./media/winGame.mp3');
//this line calls our main animation loop.
animateLineDrawing();
//This line waits 1 se.Then, clears canvas, resets game, and allows clicking again.
setTimeout(function() {clear(); resetGame(); }, 1000);
}

//This function reset the gmae in the event of a tie or a win.
function resetGame() {
